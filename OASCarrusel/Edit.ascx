<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="OASDnnModules.OASCarrusel.Edit" %>
<!-- Bootstrap CSS -->
...
<script src="/DesktopModules/OASCarrusel/js/scriptSetting.js"></script>